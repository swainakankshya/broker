...
export const getSpecialInstructionDropdown = async () => {
  const res = await axios.get(
    `/api/invoice/dropdown/specialinstructions`
  );
  return res.data;
};
...
export const searchInvoiceByPro = async (proNo) => {
  const res = await axios.get(
    `/api/invoice/byPro/${proNo}`
  );
  return res.data;
};
export const getTermsDropdown = async () => {
  const res = await axios.get(
    `/api/invoice/dropdown/terms`
  );
  return res.data;
};
...
export const getWeightDetails = async (orderNo) => {
  const res = await axios.get(
    `/api/invoice/lineitem/${orderNo}`
  );
  return res.data;
};
export const getFullInvoice = async (orderNo) => {
  const res = await axios.get(
    `/api/invoice/full/${orderNo}`
  );
  return res.data;
};
export const getConsigneeDropdown = async () => {
  const res = await axios.get(
    `/api/invoice/dropdown/consignee`
  );
  return res.data;
};
